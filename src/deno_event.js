...
class Event {
  ...
  initEvent(type, bubbles = false, cancelable = false) {
    if (getDispatched(this)) return;
    this[_attributes].type = String(type);
    this[_attributes].bubbles = !!bubbles;
    this[_attributes].cancelable = !!cancelable;
    this[_attributes].target = null;
    this[_canceledFlag] = false;
    this[_stopPropagationFlag] = false;
    this[_stopImmediatePropagationFlag] = false;
...
function getParent(eventTarget, event) {
  return eventTarget.getParent(event);
}
...
function dispatch(
  ...
  if (targetImpl !== relatedTarget || targetImpl === eventRelatedTarget) {
    ...
    while (parent !== null) {
      ...
      if (
        parent === globalThis_ || (isNode(parent) &&
